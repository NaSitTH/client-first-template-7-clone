...
const HomeStatsSection = () => {
  return (
    <section className="app-section-mt w-screen bg-app-black py-24 text-white">
      <div className="app-container flex items-center lg:flex-col lg:space-y-12">
        <div className="w-full">
          ...
          <div className="grid auto-cols-auto grid-flow-row grid-cols-3 gap-y-4 pt-8 xl:grid-cols-2 lg:grid-cols-3 md:grid-cols-2 md:px-12">
            {statistics.map((data) => {
        ...
        <div className="flex w-5/6 justify-end 2xl:w-3/5 xl:w-5/6 lg:justify-center">
          <div className="relative flex h-[375px] w-[375px] items-center justify-center 2xl:h-80 2xl:w-80 md:h-72 md:w-72">
